...
void test() {
    ...
    // FIXME: Detect this using the CFG-based lifetime analysis (temporaries of trivially-destructed types).
    //        https://github.com/llvm/llvm-project/issues/152514
    use(ptrA, ptrB, ptrC, ptrTA, ptrTB, ptrTC, ptrTSA, ptrTSB, ptrTSC);
}
} // namespace GH175391
